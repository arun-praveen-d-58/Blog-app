...
ActiveRecord::Schema[7.0].define(version: 2023_10_17_124932) do
  ...
  create_table "posts_users_read_statuses", force: :cascade do |t|
    ...
    t.index ["user_id", "post_id"], name: "index_posts_users_read_statuses_on_user_id_and_post_id", unique: true
  ...
  create_table "user_comment_ratings", force: :cascade do |t|
    ...
    t.index ["user_id", "comment_id"], name: "index_user_comment_ratings_on_user_id_and_comment_id", unique: true
